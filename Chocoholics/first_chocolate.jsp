...
String sess=(String)session.getAttribute("temp_session");
if(sess!=null) 
{	response.sendRedirect("second_chocolate.jsp?value="+chocolate_id); }
...
try
{
	...
	else
	{
		...
		*/	
		...
		String temp_session="Created";			
		session.setAttribute("temp_session",temp_session);
	}
}
catch(Exception ex)
{ System.out.println(ex); }
